...
%TODO: Nota de rodapé sobre ICAT/NIST
Dados do ICAT/NIST de 2005 já apontavam que 80\% das vulnerabilidades remotamente exploráveis estavam ligadas a má codificação do programa \cite{duarte2005}.
%
...
%TODO: http://cve.mitre.org/docs/docs-2002/prog-rpt_06-02/ CITAR
%TODO: descrever sigla CVE
A medida que o tempo vai passando, novas vunerabilidades vão sendo descobertas pela comunidade. O projeto CVE, que tem como objetivo enumerar vunerabilidades de software existentes, tinha uma lista de 321 vunerabilidades diferentes no ano de sua concepção, em 1999 \cite{cve2002}.
%
...
%TODO: o que é um modelo dimensional?
	        		\item Gerar Cubo de dados
%TODO: o que é um cubo de dado?
					\item Configurar mecanismos de visualização do cubo de dados na plataforma BI server.
%TODO: O que é BI server? ou estamos falando do Pentaho
