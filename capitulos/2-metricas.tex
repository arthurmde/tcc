...
%TODO: Tem um artigo do SBES de 2010 com este estudo publicado - referenciá-lo.
%... buscar no google atractivess free software paulo meirelles
...
%TODO: A banca deverá pegar no pé por conta da falta de referência
%... mas não vejo problemas e pensaremos para o TCC 2.
...
%
Para o desenvolvimento de códigos com bom \emph{design}, é importante que o Engenheiro de Software conheça os principais problemas de implementação conhecidos, características e princípios que compõem um paradigma e técnicas que permitem a aplicação desses princípios.
...
\item \textbf{Alta coesão} - De acordo com a Terminologia Padrão da IEEE, coesão é o grau com que cada tarefa realizada por um módulo está relacionado funcionalmente com o mesmo.
%TODO: referência ou nota sobre o padrão IEEE 
%... descrever a sigla IEEE
%
...
A concepção do \emph{design} para endereçar os problemas de software consiste na aplicação desses e outros princípios a partir de técnicas e práticas no decorrer do desenvolvimento do software.
%
...
%TODO: Se der tempo, refazer a figura em Pt-BR
%... caso não, refazer no TCC 2
...
%TODO: O que é requisitos de qualidade do cliente? podemos falar apenas em "requisitos do cliente"?
% 
...
%TODO: referência ou explicação sore propriedade coletiva do código no rodapé
%
...
%TODO: Colocar a citação indicada
%TODO: "suma importância" está aparecendo muito no texto - rever uso dessa expressão
...
%TODO: Aqui deve ser um outro capítulo
%TODO: tem muita (boa) informação até aqui e devemos deixar o leitor respirar um pouco
%TODO: Esta parte aqui ainda precisa ser melhor fechada
