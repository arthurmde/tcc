...
\subsubsection{Sistemas de Fonte de Dados Operacionais - OSS}
...
\subsubsection{Área de Preparação dos Dados - DSA}
...
\subsubsection{Área de Apresentação - DPA}
...
\subsubsection{Ferramentas de Acesso de dados – Visualização de dados}
