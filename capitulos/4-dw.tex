...
\label{cap-dw}
%TODO: juntar com o capítulo do Mezuro como um capítulo
%sobre os ambientes de tomada de decisão
...
\end{itemize}
 ...
 \begin{figure}[!htb]
 	\centering
 		...
 		\caption{Componentes de um \emph{DWing} \cite{kimball2002}}.
 		\label{componentesdw}
 \end{figure}
...
Kimball (\citeyear{kimball2002}) define os componentes básicos de um ambiente de \emph{DWing} conforme a Figura \ref{componentesdw}, onde temos:
...
%
Essas bases de dados não precisam ser necessariamente da mesma tecnologia, podendo ser um banco de dados transacionais, arquivos de texto, planilhas, arquivos XML ou qualquer outra forma de se armazenar e representar informações de negócio.
%
...
A Área de Preparação dos Dados (DSA - \emph{Data Staging Area}) é o ambiente no qual é feita a extração, transformação e carga dos dados operacionais, processo comumente chamado de ETL.
%
...
\subsection{Modelage dimensional}
...
%TODO: nova norma ortográfica define que não tem acento em ideia...
% ...eu corrigi isso em alguns lugares
