...
O estudo sobre vulnerabilidades de software nos mostrou que grande parte das vulnerabilidades são encontradas na linguagem de programação C/C++. Dessa forma, decidirmos por usar a linguagem C++ como base para instanciação dos cenários propostos a seguir, visto que se trata de uma linguagem orientada a objetos, permitindo aplicarmos tanto os conceitos estudados a respeito de \emph{design} de código quanto os conceitos estudados a respeito de vulnerabilidades específicas.
